...
UNITEST_FIXTURE = [
    ...
    ['order', (ADDR[0], 'DLA', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DIVISIBLE', DP['quantity']), {'encoding': 'multisig'}],
    ['send', (ADDR[0], ADDR[1], 'DLA', DP['quantity']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'DLA', DP['quantity'], 'DIVISIBLE', DP['quantity'], 2000, 0), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'DLA', DP['quantity'], 'LTC', round(DP['quantity'] / 100), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[0], 'LTC', round(DP['quantity'] / 150), 'DLA', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
    ['send', (ADDR[0], MULTISIGADDR[0], 'DLA', DP['quantity'] * 3), {'encoding': 'multisig'}],
    ...
    ['order', (ADDR[0], 'DLA', DP['quantity'], 'LTC', round(DP['quantity'] / 125), 2000, DP['fee_required']), {'encoding': 'multisig'}],
    ['order', (ADDR[1], 'LTC', round(DP['quantity'] / 125), 'DLA', DP['quantity'], 2000, 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
...
def generate_standard_scenario(address1, address2, order_matches, rps_matches):
    return [
        ...
        ['send', (address1, address2, 'DLA', DP['small']), {'encoding': 'multisig'}],
        ['order', (address1, 'LTC', DP['small'], 'DLA', DP['small'] * 2, DP['expiration'], 0), {'encoding': 'multisig', 'fee_provided': DP['fee_provided']}],
        ['order', (address1, 'DLA', round(DP['small'] * 2.1), 'LTC', DP['small'], DP['expiration'], DP['fee_required']), {'encoding': 'multisig'}],
        ['ltcpay', (address1, order_matches[0]), {'encoding': 'multisig'}],
        ...
        ['dividend', (address1, 600, 'BBBB', 'DLA'), {'encoding': 'multisig'}],
        ['dividend', (address1, 800, 'BBBC', 'DLA'), {'encoding': 'multisig'}],
        ...
        ['order', (address1, 'BBBB', DP['small'], 'DLA', DP['small'], DP['expiration'], 0), {'encoding': 'multisig'}],
        ['burn', (address1, (1 * DP['quantity']), True), {'encoding': 'multisig'}],  # Try to burn a whole 'nother LTC.
