...
def version_check (db):
    try:
        host = 'https://raw.githubusercontent.com/Paytokens/paytokensd/evolve/version.json'
    ...
    if not passed:
        explanation = 'Your version of paytokensd is v{}, but, as of block {}, the minimum version is v{}.{}.{}. Reason: ‘{}’. Please upgrade to the latest version and restart the server.'.format(
